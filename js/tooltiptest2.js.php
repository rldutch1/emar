...
hvrinfo.push(\"		2.  <select><option value='1'>Robert Lester Holland</option><option value='2'>Jeanette Ann Holland</option><option value='3'>Leah Patricia Holland</option><option value='4'>Jason Spriggs Holland</option><option value='5'>Keira Moylan Holland</option><option value='6'>Stanley David Holland</option><option value='7'>Vernon Clabron Holland III</option></select>\");
hvrinfo.push(\"	</div>\");
